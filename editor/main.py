...
class Editor(QMainWindow):
    def __init__(self,project:str|Path):
        ...
        self.scene_tab=SceneEditor(self.project); self.tabs.addTab(self.scene_tab,'Scene'); self.dialogue_tab=DialogueEditor(self.project); self.tabs.addTab(self.dialogue_tab,'Dialogue'); self.ui_tab=UIEditor(self.project); self.tabs.addTab(self.ui_tab,'UI'); self.reload()
