...
class AIProjectBuilder:
    ...
    def _dispatch(self,operation):
        ...
        names=("create_project","set_variable","create_map","add_component","remove_component","add_resource","remove_resource","add_scene","remove_scene","add_scene_action","say","choice","set_action","change_action","goto","label","add_node","add_connection","add_entity","set_entity_component","remove_entity_component","apply_entity_components","set_map_property","set_entity_property","remove_node","remove_entity")
