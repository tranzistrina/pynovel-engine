...
class ExtensibleRuntime(CoreRuntime):
    ...
    def _call_system(self, action: Action) -> None:
        ...
        method_name = action.data["method"]
    ...
    def save_bundle(self, path, project_version: str = "1") -> None:
        bundle = SaveBundle("0.31.0", project_version)
        bundle.state = {"runtime": self.state.variables, "extensions": self.game_state.serialize()}
        ...
        bundle.state["scheduler"] = self.scheduler.serialize()
        bundle.save(path)
    ...
    def load_bundle(self, path, project_version: str = "1") -> None:
        ...
        self.state.variables = dict(bundle.state.get("runtime", {}))
        self.game_state.deserialize(bundle.state.get("extensions", {}))
        ...
        self.rng.deserialize(bundle.rng)
        self.scheduler.deserialize(bundle.state.get("scheduler", {}))
