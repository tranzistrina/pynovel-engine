...
class Game:
    ...
    def run(self):
        ...
        self.screen=pygame.display.set_mode((1280,720),pygame.RESIZABLE); pygame.display.set_caption(self.runtime.state.story.title); clock=pygame.time.Clock(); self.runtime.advance()
        while self.runtime.state.running:
            for e in pygame.event.get():
                if e.type==pygame.QUIT:self.runtime.state.running=False
                elif e.type==pygame.KEYDOWN:self._key(e.key)
